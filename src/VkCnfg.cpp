...
void Vulkan::initVulkan(VkInstance *instance, VkSurfaceKHR *surface)
{
...
void Vulkan::createGraphicsPipeline()
{
	...
	auto bindingDescription = Vertex::getBindingDestription();
...
uint32_t Vulkan::findMemoryType(uint16_t typeFilter,
